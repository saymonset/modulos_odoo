    ...
    def _get_pasos_para_resultados_lab(self):
        ...
        return [
            ...
            },
            {
                "secuencia": 11.5,
                "nombre_interno": "solicitar_imagenes_adicionales",
                "nombre_mostrar": "Imagen del estudio o resultados",
                "tipo_dato": "image",
                "campo_destino": "imagenes_adicionales",
                "es_requerido": False,
                "es_paso_telefono": False,
                "mensaje_prompt": "Por favor, envíe una foto o imagen de sus resultados de laboratorio. Puede enviar varias imágenes. Si no tiene la imagen, escriba 'saltar' para continuar.",
                "mensaje_error": "Por favor envía una imagen clara de tus resultados.",
            },
            {
                "secuencia": 22,
                "nombre_interno": "solicitar_consentimiento",
    ...
    def _get_pasos_para_resultados_imagenes(self):
        ...
        return [
            ...
            },
            {
                ...
                "es_requerido": False,
                "es_paso_telefono": False,
                "mensaje_prompt": "Por favor, envíe una foto o imagen del estudio o de sus resultados de imagenología. Puede enviar varias imágenes. Si no tiene la imagen, escriba 'saltar' para continuar.",
                "mensaje_error": "Por favor envía una imagen clara del estudio o sus resultados.",
            },
            {
                "secuencia": 22,
                "nombre_interno": "solicitar_consentimiento",
