...
def redact_prompt_vendedor():
    ...
    return (
        ...
        "REGLAS INVIOLABLES:\n"
        "1. El LISTADO NUMERADO y las LISTAS VIÑETA (• ) son INTANGIBLES: "
        "si la plantilla trae '1. Nombre — precio' o líneas con '•', copia "
        "cada línea EXACTA con su índice y su precio; NUNCA elimines "
        "números, viñetas, reordenes ni resumas un listado. Solo humaniza "
        "el texto que rodea la lista.\n"
